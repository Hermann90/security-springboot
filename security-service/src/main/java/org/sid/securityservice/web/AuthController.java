...
public class AuthController {
    ...
    public AuthController(JwtEncoder jwtEncoder, UserDetailsService userDetailsService, JwtDecoder jwtDecoder, AuthenticationManager authenticationManager) {
